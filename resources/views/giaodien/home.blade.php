            ...
            <div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate heading-section heading-section-white">
                ...
                <form action="#" class="appointment">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" required="text" placeholder="Tên Bạn">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text"  minlength="10" pattern="\d*" maxlength="13"  class="form-control" placeholder="Số điện thoại">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-wrap">
                                    ...
                                    <input type="datetime-local" required="text" class="form-control" placeholder="Ngày đặt">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" required="email" class="form-control" placeholder="Hòm thư">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
